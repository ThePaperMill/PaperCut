/****************************************************************************/
/*!
\file  InvokeSplashTransitions.cs
\author Troy 
\brief  
      Uses Invoke() to run through the splash screens instead of
Time.deltaTime since that doesn't work after the application loses focus.
...
public class InvokeSplashTransitions : MonoBehaviour 
{
