...
class GlobalControls
{
    ...
    public static List<InputCodes> SkipButtons = new List<InputCodes> { KeyCode.Return, KeyCode.Space,KeyCode.Escape,XINPUT_BUTTONS.BUTTON_A,XINPUT_BUTTONS.BUTTON_START};
}
